...
*	1.0				2022/12/02	SA1			1. First version released
...
int	main(void)
{
	...
	SN_GPIO0->DATA = 0x0000;

	RTC_Init();

	#if	(RTC_MODE == SECOND)
	SN_GPIO0->DATA_b.DATA0 = 1;			//Set P0.0 as output high
	#endif
