...
//Gowin_AHB_HyperRAM_Top
module Gowin_AHB_HyperRAM_Top
(
	//AHB bus IO
...
begin
	...
	begin
		case (ahb_address[11:2])
			...
			10'h001: reg_address	<= AHB_HWDATA[21:0];
...
begin
	...
	begin
	    ...
	    10'h001: ahb_rdata = {10'h0,reg_address};
...
reg [31:0] hpram_wrdata;

always @(*)
begin
	case (data_sel)
	2'b00:hpram_wrdata = reg_data_in0;
	2'b01:hpram_wrdata = reg_data_in1;
	2'b10:hpram_wrdata = reg_data_in2;
	2'b11:hpram_wrdata = reg_data_in3;
	endcase
end
	...
	begin
		...
		3'd1:
			 begin
				if(rd_valid)
				begin
					reg_data_out0 <= hpram_data_out;
					rd_state	  <= rd_state + 1'b1;
				end
			 end
		3'd2:
			 begin
					reg_data_out1 <= hpram_data_out;
					rd_state	  <= rd_state + 1'b1;
			 end
		3'd3:
			 begin
					reg_data_out2 <= hpram_data_out;
					rd_state	  <= rd_state + 1'b1;
			 end
		3'd4:
			 begin
					reg_data_out3 <= hpram_data_out;
					rd_state	  <= 3'd0;
			 end
		endcase
	end
...
HyperRAM_Memory_Interface_Top u_HyperRAM_Memory_Interface_Top
(
    .clk			(hpram_base_clk         ),
    .memory_clk		(hpram_memory_clk       ),
    .rst_n			(AHB_HRESETn            ),
    .pll_lock		(1'b1   	            ),
     //phy IO                             
    ...
    .wr_data		(hpram_wrdata           ),
    .rd_data		(hpram_data_out         ),
