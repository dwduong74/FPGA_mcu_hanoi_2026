...
C_SRCS += \
../src/library/middlewares/3rd_party/ucos_iii/LIB/lib_ascii.c \
../src/library/middlewares/3rd_party/ucos_iii/LIB/lib_math.c \
../src/library/middlewares/3rd_party/ucos_iii/LIB/lib_mem.c \
../src/library/middlewares/3rd_party/ucos_iii/LIB/lib_str.c 

OBJS += \
./src/library/middlewares/3rd_party/ucos_iii/LIB/lib_ascii.o \
./src/library/middlewares/3rd_party/ucos_iii/LIB/lib_math.o \
./src/library/middlewares/3rd_party/ucos_iii/LIB/lib_mem.o \
./src/library/middlewares/3rd_party/ucos_iii/LIB/lib_str.o 

C_DEPS += \
./src/library/middlewares/3rd_party/ucos_iii/LIB/lib_ascii.d \
./src/library/middlewares/3rd_party/ucos_iii/LIB/lib_math.d \
./src/library/middlewares/3rd_party/ucos_iii/LIB/lib_mem.d \
./src/library/middlewares/3rd_party/ucos_iii/LIB/lib_str.d 


# Each subdirectory must supply rules for building sources it contributes
src/library/middlewares/3rd_party/ucos_iii/LIB/%.o: ../src/library/middlewares/3rd_party/ucos_iii/LIB/%.c
	@echo 'Building file: $<'
