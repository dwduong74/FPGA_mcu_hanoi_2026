...
C_SRCS += \
../src/library/middlewares/gpio/gpio.c 

OBJS += \
./src/library/middlewares/gpio/gpio.o 

C_DEPS += \
./src/library/middlewares/gpio/gpio.d 


# Each subdirectory must supply rules for building sources it contributes
src/library/middlewares/gpio/%.o: ../src/library/middlewares/gpio/%.c
	@echo 'Building file: $<'
