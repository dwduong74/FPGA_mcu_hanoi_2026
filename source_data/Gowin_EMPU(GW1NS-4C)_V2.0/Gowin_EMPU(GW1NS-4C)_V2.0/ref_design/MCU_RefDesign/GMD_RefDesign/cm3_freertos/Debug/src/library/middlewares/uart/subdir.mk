...
C_SRCS += \
../src/library/middlewares/uart/uart.c 

OBJS += \
./src/library/middlewares/uart/uart.o 

C_DEPS += \
./src/library/middlewares/uart/uart.d 


# Each subdirectory must supply rules for building sources it contributes
src/library/middlewares/uart/%.o: ../src/library/middlewares/uart/%.c
	@echo 'Building file: $<'
