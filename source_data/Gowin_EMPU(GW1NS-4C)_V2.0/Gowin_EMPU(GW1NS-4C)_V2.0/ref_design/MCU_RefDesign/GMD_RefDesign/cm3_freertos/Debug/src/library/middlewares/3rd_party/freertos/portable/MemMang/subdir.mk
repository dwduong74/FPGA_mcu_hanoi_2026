...
C_SRCS += \
../src/library/middlewares/3rd_party/freertos/portable/MemMang/heap_4.c 

OBJS += \
./src/library/middlewares/3rd_party/freertos/portable/MemMang/heap_4.o 

C_DEPS += \
./src/library/middlewares/3rd_party/freertos/portable/MemMang/heap_4.d 


# Each subdirectory must supply rules for building sources it contributes
src/library/middlewares/3rd_party/freertos/portable/MemMang/%.o: ../src/library/middlewares/3rd_party/freertos/portable/MemMang/%.c
	@echo 'Building file: $<'
