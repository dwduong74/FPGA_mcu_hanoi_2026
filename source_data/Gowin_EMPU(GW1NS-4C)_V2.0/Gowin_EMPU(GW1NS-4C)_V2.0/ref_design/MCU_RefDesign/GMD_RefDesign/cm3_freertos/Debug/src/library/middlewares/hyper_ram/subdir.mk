...
C_SRCS += \
../src/library/middlewares/hyper_ram/hyper_ram.c 

OBJS += \
./src/library/middlewares/hyper_ram/hyper_ram.o 

C_DEPS += \
./src/library/middlewares/hyper_ram/hyper_ram.d 


# Each subdirectory must supply rules for building sources it contributes
src/library/middlewares/hyper_ram/%.o: ../src/library/middlewares/hyper_ram/%.c
	@echo 'Building file: $<'
