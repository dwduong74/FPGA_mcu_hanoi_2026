...
C_SRCS += \
../src/project/uart_rx_intr/uart_rx_intr_demo.c 

OBJS += \
./src/project/uart_rx_intr/uart_rx_intr_demo.o 

C_DEPS += \
./src/project/uart_rx_intr/uart_rx_intr_demo.d 


# Each subdirectory must supply rules for building sources it contributes
src/project/uart_rx_intr/%.o: ../src/project/uart_rx_intr/%.c
	@echo 'Building file: $<'
