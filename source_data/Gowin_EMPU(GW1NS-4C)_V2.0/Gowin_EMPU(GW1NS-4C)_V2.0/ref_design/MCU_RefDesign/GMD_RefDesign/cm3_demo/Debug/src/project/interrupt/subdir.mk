...
C_SRCS += \
../src/project/interrupt/interrupt_demo.c 

OBJS += \
./src/project/interrupt/interrupt_demo.o 

C_DEPS += \
./src/project/interrupt/interrupt_demo.d 


# Each subdirectory must supply rules for building sources it contributes
src/project/interrupt/%.o: ../src/project/interrupt/%.c
	@echo 'Building file: $<'
