...
C_SRCS += \
../src/project/i2c_master/i2c_master_demo.c 

OBJS += \
./src/project/i2c_master/i2c_master_demo.o 

C_DEPS += \
./src/project/i2c_master/i2c_master_demo.d 


# Each subdirectory must supply rules for building sources it contributes
src/project/i2c_master/%.o: ../src/project/i2c_master/%.c
	@echo 'Building file: $<'
