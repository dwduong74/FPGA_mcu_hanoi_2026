...
C_SRCS += \
../src/library/middlewares/spi_flash/spi_flash.c 

OBJS += \
./src/library/middlewares/spi_flash/spi_flash.o 

C_DEPS += \
./src/library/middlewares/spi_flash/spi_flash.d 


# Each subdirectory must supply rules for building sources it contributes
src/library/middlewares/spi_flash/%.o: ../src/library/middlewares/spi_flash/%.c
	@echo 'Building file: $<'
