...
C_SRCS += \
../src/library/middlewares/3rd_party/rtthread_nano/components/device/device.c 

OBJS += \
./src/library/middlewares/3rd_party/rtthread_nano/components/device/device.o 

C_DEPS += \
./src/library/middlewares/3rd_party/rtthread_nano/components/device/device.d 


# Each subdirectory must supply rules for building sources it contributes
src/library/middlewares/3rd_party/rtthread_nano/components/device/%.o: ../src/library/middlewares/3rd_party/rtthread_nano/components/device/%.c
	@echo 'Building file: $<'
