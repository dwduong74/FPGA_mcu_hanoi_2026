...
C_SRCS += \
../src/library/middlewares/3rd_party/freertos/portable/GMD/cm3/port.c 

OBJS += \
./src/library/middlewares/3rd_party/freertos/portable/GMD/cm3/port.o 

C_DEPS += \
./src/library/middlewares/3rd_party/freertos/portable/GMD/cm3/port.d 


# Each subdirectory must supply rules for building sources it contributes
src/library/middlewares/3rd_party/freertos/portable/GMD/cm3/%.o: ../src/library/middlewares/3rd_party/freertos/portable/GMD/cm3/%.c
	@echo 'Building file: $<'
