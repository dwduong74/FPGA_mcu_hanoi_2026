...
C_SRCS += \
../src/library/middlewares/uart/gmd/retarget.c 

OBJS += \
./src/library/middlewares/uart/gmd/retarget.o 

C_DEPS += \
./src/library/middlewares/uart/gmd/retarget.d 


# Each subdirectory must supply rules for building sources it contributes
src/library/middlewares/uart/gmd/%.o: ../src/library/middlewares/uart/gmd/%.c
	@echo 'Building file: $<'
