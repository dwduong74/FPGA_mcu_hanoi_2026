...
C_SRCS += \
../src/library/middlewares/3rd_party/ucos_iii/CONFIG/os_app_hooks.c 

OBJS += \
./src/library/middlewares/3rd_party/ucos_iii/CONFIG/os_app_hooks.o 

C_DEPS += \
./src/library/middlewares/3rd_party/ucos_iii/CONFIG/os_app_hooks.d 


# Each subdirectory must supply rules for building sources it contributes
src/library/middlewares/3rd_party/ucos_iii/CONFIG/%.o: ../src/library/middlewares/3rd_party/ucos_iii/CONFIG/%.c
	@echo 'Building file: $<'
