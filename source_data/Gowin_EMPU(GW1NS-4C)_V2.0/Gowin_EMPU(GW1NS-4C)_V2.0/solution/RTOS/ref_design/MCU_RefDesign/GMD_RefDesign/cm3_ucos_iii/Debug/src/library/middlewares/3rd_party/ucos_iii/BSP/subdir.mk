...
C_SRCS += \
../src/library/middlewares/3rd_party/ucos_iii/BSP/bsp.c 

OBJS += \
./src/library/middlewares/3rd_party/ucos_iii/BSP/bsp.o 

C_DEPS += \
./src/library/middlewares/3rd_party/ucos_iii/BSP/bsp.d 


# Each subdirectory must supply rules for building sources it contributes
src/library/middlewares/3rd_party/ucos_iii/BSP/%.o: ../src/library/middlewares/3rd_party/ucos_iii/BSP/%.c
	@echo 'Building file: $<'
