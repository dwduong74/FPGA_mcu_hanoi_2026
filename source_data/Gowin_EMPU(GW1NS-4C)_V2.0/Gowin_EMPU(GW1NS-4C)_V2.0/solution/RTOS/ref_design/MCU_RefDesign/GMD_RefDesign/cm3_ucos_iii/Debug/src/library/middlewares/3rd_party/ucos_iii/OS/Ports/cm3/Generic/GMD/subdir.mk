...
C_SRCS += \
../src/library/middlewares/3rd_party/ucos_iii/OS/Ports/cm3/Generic/GMD/os_cpu_c.c 

S_UPPER_SRCS += \
../src/library/middlewares/3rd_party/ucos_iii/OS/Ports/cm3/Generic/GMD/os_cpu_a.S 

OBJS += \
./src/library/middlewares/3rd_party/ucos_iii/OS/Ports/cm3/Generic/GMD/os_cpu_a.o \
./src/library/middlewares/3rd_party/ucos_iii/OS/Ports/cm3/Generic/GMD/os_cpu_c.o 

S_UPPER_DEPS += \
./src/library/middlewares/3rd_party/ucos_iii/OS/Ports/cm3/Generic/GMD/os_cpu_a.d 

C_DEPS += \
./src/library/middlewares/3rd_party/ucos_iii/OS/Ports/cm3/Generic/GMD/os_cpu_c.d 


# Each subdirectory must supply rules for building sources it contributes
src/library/middlewares/3rd_party/ucos_iii/OS/Ports/cm3/Generic/GMD/%.o: ../src/library/middlewares/3rd_party/ucos_iii/OS/Ports/cm3/Generic/GMD/%.S
	@echo 'Building file: $<'
...
src/library/middlewares/3rd_party/ucos_iii/OS/Ports/cm3/Generic/GMD/%.o: ../src/library/middlewares/3rd_party/ucos_iii/OS/Ports/cm3/Generic/GMD/%.c
	@echo 'Building file: $<'
