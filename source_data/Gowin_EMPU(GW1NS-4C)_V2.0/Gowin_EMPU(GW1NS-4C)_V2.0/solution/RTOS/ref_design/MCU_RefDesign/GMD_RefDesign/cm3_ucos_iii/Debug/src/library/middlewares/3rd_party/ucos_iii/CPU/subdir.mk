...
C_SRCS += \
../src/library/middlewares/3rd_party/ucos_iii/CPU/cpu_core.c 

OBJS += \
./src/library/middlewares/3rd_party/ucos_iii/CPU/cpu_core.o 

C_DEPS += \
./src/library/middlewares/3rd_party/ucos_iii/CPU/cpu_core.d 


# Each subdirectory must supply rules for building sources it contributes
src/library/middlewares/3rd_party/ucos_iii/CPU/%.o: ../src/library/middlewares/3rd_party/ucos_iii/CPU/%.c
	@echo 'Building file: $<'
