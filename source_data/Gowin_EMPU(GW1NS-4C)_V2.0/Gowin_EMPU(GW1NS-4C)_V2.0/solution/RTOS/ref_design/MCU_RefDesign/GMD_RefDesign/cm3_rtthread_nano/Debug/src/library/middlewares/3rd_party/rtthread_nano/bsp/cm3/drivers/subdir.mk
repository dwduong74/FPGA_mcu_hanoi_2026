...
C_SRCS += \
../src/library/middlewares/3rd_party/rtthread_nano/bsp/cm3/drivers/board.c 

OBJS += \
./src/library/middlewares/3rd_party/rtthread_nano/bsp/cm3/drivers/board.o 

C_DEPS += \
./src/library/middlewares/3rd_party/rtthread_nano/bsp/cm3/drivers/board.d 


# Each subdirectory must supply rules for building sources it contributes
src/library/middlewares/3rd_party/rtthread_nano/bsp/cm3/drivers/%.o: ../src/library/middlewares/3rd_party/rtthread_nano/bsp/cm3/drivers/%.c
	@echo 'Building file: $<'
