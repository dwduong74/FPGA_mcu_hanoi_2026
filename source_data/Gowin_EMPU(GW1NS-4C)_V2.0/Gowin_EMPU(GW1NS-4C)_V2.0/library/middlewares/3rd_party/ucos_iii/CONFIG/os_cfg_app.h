...
#define  OS_CFG_ISR_STK_SIZE              64u               /* Stack size of ISR stack (number of CPU_STK elements)   */
#define  OS_CFG_TASK_STK_LIMIT_PCT_EMPTY  10u               /* Stack limit position in percentage to empty            */


                                                            /* ---------------------- IDLE TASK --------------------- */
#define  OS_CFG_IDLE_TASK_STK_SIZE        32u               /* Stack size (number of CPU_STK elements)                */


                                                            /* ------------------ ISR HANDLER TASK ------------------ */
#define  OS_CFG_INT_Q_SIZE                10u               /* Size of ISR handler task queue                         */
#define  OS_CFG_INT_Q_TASK_STK_SIZE       32u               /* Stack size (number of CPU_STK elements)                */
...
#define  OS_CFG_TICK_TASK_STK_SIZE        32u               /* Stack size (number of CPU_STK elements)                */
...
#define  OS_CFG_TMR_TASK_STK_SIZE         32u               /* Stack size (number of CPU_STK elements)                */
